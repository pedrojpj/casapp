define(["jquery",
	...
	"text!templates/telefonos.html"], function(
		$, _, Backbone, Handlebars, iscroll, plugins, literales, animations, help, map, elements, storage, alertas, c, m, helpers, headerIndex, headerContent, headerBasic, layoutIntro, layoutIndex, layoutAsistencia, layoutAsistenciaForm, layoutTalleres, layoutTalleresMap, layoutAjustes, layoutAlertas, layoutUrgencias, layoutGuia, layoutContacto, layoutOficinas, layoutOficinasMap, layoutTelefonos) {
		...
		var templateIndex = Backbone.View.extend({
			...
			render: function() {
				...
				var size = $(".home .footer").find("li").outerWidth(true) * ($(".home .footer").find("li").length);

				$("#scroller").width(size-30);
